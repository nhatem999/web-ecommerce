            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            <label>Ảnh 2</label>
                            <input type="file" multiple class="form-control-file" name="feature_image2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('discount') is-invalid @enderror" name="discount"
                                value="{{ old('discount') }}" id="discount" placeholder="Nhập số % cần giảm">
                            @error('discount')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('quantity') is-invalid @enderror" name="quantity"
                                id="quantity" placeholder="Nhập số lượng sản phẩm">
                            @error('quantity')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
